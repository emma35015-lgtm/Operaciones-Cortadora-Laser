    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section id="galeria" className="py-16 md:py-24 px-6 md:px-16 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {GALLERY.map(({ id, label }) => (
            <div key={id} className="rounded-xl overflow-hidden border border-gray-200 shadow-sm bg-white">
      ...
      <section id="proyecto" className="py-16 md:py-24 px-6 md:px-16 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 bg-gray-50 border border-gray-200 rounded-xl p-5 md:p-6">
      ...
      <section id="marco" className="py-16 md:py-24 px-6 md:px-16 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-3 md:gap-4">
          {MARCO_TEORICO.map(({ term, def }) => (
            <div key={term} className="bg-gray-50 border border-gray-200 rounded-xl p-4 md:p-6 hover:border-[#E8192C]/40 transition-colors">
      ...
      <section id="tarea" className="py-16 md:py-24 px-6 md:px-16 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          {ELEMENTS.map(({ num, title, desc }) => (
            <div key={num} className="group bg-white border border-gray-200 rounded-xl p-4 md:p-6 hover:border-[#E8192C]/50 hover:shadow-md transition-all">
              <span className="text-4xl md:text-5xl font-black text-[#E8192C]/15 group-hover:text-[#E8192C]/30 transition-colors">{num}</span>
              <h3 className="text-gray-900 font-semibold mt-1 mb-1 md:mt-2 md:mb-2 text-sm md:text-base">{title}</h3>
      ...
      <section id="metodologia" className="py-16 md:py-24 px-6 md:px-16 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
          {[
            ...
            <div key={title} className="bg-gray-50 border border-gray-200 rounded-xl p-4 md:p-6">
      ...
      <section id="descarga" className="py-16 md:py-24 px-6 md:px-16 bg-gray-50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href={`https://drive.google.com/uc?export=download&id=${EXCEL_ID}`}
            target="_blank"
            rel="noopener noreferrer"
