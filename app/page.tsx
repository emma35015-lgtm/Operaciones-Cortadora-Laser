        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="flex-1 md:flex-none md:w-2/5 px-6 py-8 md:p-14 relative z-10 flex flex-col justify-center overflow-y-auto">
            <AnimSection delay={0}>
              ...
              <h1 className="text-6xl md:text-8xl font-black leading-none text-gray-900 mb-3">
                Herraidea
              </h1>
              <p className="text-base md:text-xl font-semibold text-gray-500 mb-1">
                Estudio de Tiempos
              </p>
              <p className="text-base md:text-xl font-semibold text-[#E8192C] mb-4">
                Cortadora Láser Fibra
              </p>
              <p className="text-gray-400 max-w-sm text-sm leading-relaxed">
                León, Guanajuato · Determinación del Tiempo Estándar Permitido
                con calificación Westinghouse y análisis MTM-1.
              </p>
              <div className="mt-7 flex flex-wrap gap-3">
                <a href={EXCEL_URL} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#E8192C] hover:bg-[#b91224] text-white font-semibold px-5 py-2.5 rounded-lg transition-all hover:scale-105 text-sm">
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <div className="text-left">
                    <p className="font-bold leading-tight text-xs">Descargar Excel</p>
                    <p className="text-white/70 text-xs font-normal">Segundo Parcial</p>
                  </div>
                </a>
                <a href={PDF_URL} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-gray-900 hover:bg-gray-700 text-white font-semibold px-5 py-2.5 rounded-lg transition-all hover:scale-105 text-sm">
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  <div className="text-left">
                    <p className="font-bold leading-tight text-xs">Descargar Reporte</p>
